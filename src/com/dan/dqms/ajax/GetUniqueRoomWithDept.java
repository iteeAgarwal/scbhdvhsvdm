...
@WebServlet("/GetUniqueRoomWithDept")
public class GetUniqueRoomWithDept extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public GetUniqueRoomWithDept() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
Print.logInfo("GetUniqueRoomWithDept:doPost", null);
		...
		{
			Print.logException("Exception in  GetRoomWithDept class"
					,e);
		}
