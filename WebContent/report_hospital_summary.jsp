...
<%@ page import="com.dan.dqms.returnlist.HospitalSummayReport"%>
<%@ page import="com.dan.dqms.returnlist.HospitalSummaryHelper"%>
		...
		<div id="report_table1">
			...
			<TABLE BORDER="0" WIDTH="100%">
				...
				<TH COLSPAN="5"
					...
					<b> Hospital Summary</b><div id="R_SUM"></div>
			...
			<div id="cont_shadow">
				...
				<div id="status">
					<table id="IP_tableTH" width="100%" align="center"
						...
						<tbody>
							<tr
								style="background: #007E9C; height: 40px; font-size: 16px;text-align: center; color: #fff; font-weight: normal; font-family: Arial, Helvetica, sans-serif;">


								<th>Total Patient</th>
								<th>Total Treated</th>
								<th>Doctor Average Working Time</th>
								<th>Patient Average Waiting Time</th>
								...
								ArrayList<HospitalSummaryHelper> list_hos_summ = (ArrayList<HospitalSummaryHelper>) request
								.getAttribute("hos_summ");
								if (list_hos_summ!=null && list_hos_summ.size() > 0) {
								for (HospitalSummaryHelper hos_summ : list_hos_summ) {
									%>
									<tr
								style="height: 25px; font-size: 14px; text-align: center"">

								<td><%=hos_summ.getTotal_pateints() %></td>
								<td><%=hos_summ.getTotal_treated() %></td>
								<td><%=hos_summ.getAvrworkingtime() %></td>
								<td><%=hos_summ.getAvrwaitingtime() %></td>
								...
								<td id="response_mess" align="center"><%="No Record Found !!"%></td>
							</tr>
									<%
								}
							%>
